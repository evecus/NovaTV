...
public class ConnectionManagerService {
    ...
    private Integer A_ARG_TYPE_ConnectionID = 0;

    @UpnpStateVariable(sendEvents = false, defaultValue = "-1", datatype = "i4")
    private Integer A_ARG_TYPE_RcsID = 0;

    @UpnpStateVariable(sendEvents = false, defaultValue = "-1", datatype = "i4")
    private Integer A_ARG_TYPE_AVTransportID = 0;
    ...
    public void getCurrentConnectionInfo(
            @UpnpInputArgument(name = "ConnectionID", stateVariable = "A_ARG_TYPE_ConnectionID") Integer connectionId) {
    }
    ...
    public Integer getPeerConnectionId() {
        return -1;
    }

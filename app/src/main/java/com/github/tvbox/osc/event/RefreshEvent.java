...
public class RefreshEvent {
    ...
    /** DLNA 投屏控制 */
    public static final int TYPE_CAST_PLAY = 23;
    public static final int TYPE_CAST_PAUSE = 24;
    public static final int TYPE_CAST_STOP = 25;
    /** DLNA 投屏 Seek,obj = 毫秒 */
    public static final int TYPE_CAST_SEEK = 26;
    public int type;
    public Object obj;

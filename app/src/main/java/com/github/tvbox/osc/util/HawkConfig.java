...
public class HawkConfig {
    ...
    public static final String LIVE_PLAY_TYPE = "live_play_type";//0 EXO硬解 1 EXO软解 2 IJK硬解 3 IJK软解
    public static final String LIVE_IJK_CODEC = "live_ijk_codec";//直播专用 IJK 解码：硬解码/软解码（独立于点播）
    ...
    public static final String DANMU_LINE_SPACING = "danmu_line_spacing";
    /** 行间距(px)存储键,用独立 key 避免与旧的比例值(danmu_line_spacing 存过 float)冲突 */
    ...
    public static final String VOD_CURRENT_CONFIG = "vod_current_config";
    public static final String VOD_CURRENT_ROUTE = "vod_current_route";
}

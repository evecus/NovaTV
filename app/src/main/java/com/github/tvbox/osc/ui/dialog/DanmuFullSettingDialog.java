...
public class DanmuFullSettingDialog extends BaseDialog {
    ...
    private static final String[] ITEM_NAMES = {"地址", "字号", "屏占比", "滚动速度", "透明度", "行间距", "顶部边距"};
    ...
    private static final int IDX_LINE_SPACING = 5;
    private static final int IDX_TOP_MARGIN = 6;

    /** 顶部边距档位(px):粗粒度,默认 40(电视顶部留一点呼吸空间) */
    ...
    private View panelApi, panelSize, panelRatio, panelSpeed, panelAlpha, panelLineSpacing, panelTopMargin;
    private EditText inputApi;
    private LinearLayout llSizeOptions, llRatioOptions, llSpeedOptions, llAlphaOptions, llLineSpacingOptions, llTopMarginOptions;

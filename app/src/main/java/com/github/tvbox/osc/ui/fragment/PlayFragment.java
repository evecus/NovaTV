...
public class PlayFragment extends BaseLazyFragment {
    ...
    public void refresh(RefreshEvent event) {
        ...
        if (event.type == RefreshEvent.TYPE_SET_DANMU_SETTINGS) {
            ...
            if (mController != null) mController.updateDanmuBtn();
    ...
    private void initView() {
        ...
        mController.setListener(new VodController.VodControlListener() {
            ...
            public void toggleDanmu() {
                boolean newState = !DanmuHelper.isOpen();
                DanmuHelper.setOpen(newState);
                // 开启弹幕时需要 reload=true 触发 prepare，否则弹幕不会立即显示
                setDanmuViewSettings(newState);
            }
